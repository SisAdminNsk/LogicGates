...
{
    public class CreateLogicalANDCommand : BaseCreateLogicalGateCommand
    {
        public CreateLogicalANDCommand(string elementName,BaseDesiginationSymbol desiginationSymbol) : 
